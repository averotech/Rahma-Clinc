...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    UplodeOfferImage: function UplodeOfferImage(key) {
      document.getElementById(key).click();
    },
    removeImageSlider: function removeImageSlider(key, type) {
      console.log("remoooooove");
      axios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/removeImageSlider", {
        key: key,
        type: type
      });
    ...
    secondBanner: function secondBanner(e, key, index, type) {
      if (type == "photo") {
        if (!this.secondBannerArray[index]) {
          ...
          this.secondBannerArray.push(_defineProperty({}, key, _defineProperty({}, type, e.target.files[0])));
      ...
      if (type == "title") {
        if (!this.secondBannerArray[index]) {
          console.log("etarget", e.target.id);
          this.keyVal.push(key);
          this.secondBannerArray.push(_defineProperty({}, key, _defineProperty({}, type, e.target.value)));
        } else {
          console.log("etarget", e.target.id);
    ...
    addSecondBannerList: function addSecondBannerList(e) {
      e.preventDefault();
      if (this.counter == 0) {
    ...
    addOfferBannerList: function addOfferBannerList(e) {
      e.preventDefault();
      if (this.counter == 0) {
    ...
    getImeageSlider: function getImeageSlider() {
      var _this = this;
      axios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/getImeageSlider").then(function (response) {
    ...
    setImeageSlider: function setImeageSlider(event, key) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/setImeageSlider", formData, {
        headers: {
          "Content-Type": "multipart/form-data"
        }
      }).then(function (response) {
        console.log("on then");
        _this2.getImeageSlider();
        console.log("intime slider ", _this2.ImageSlider);
      })["catch"](function (error) {
        _this2.errors = error.response.data.errors;
      });
    },
    setImagesecondBanner: function setImagesecondBanner() {
      var _this3 = this;
      var formData = new FormData();
      for (var index = 0; index < this.keyVal.length; index++) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/setImeagesecondBanner", formData, {
          headers: {
            "Content-Type": "multipart/form-data"
          }
        }).then(function (response) {
          console.log("on then");
          _this3.getImagesecondBanner();
        })["catch"](function (error) {
          _this3.errors = error.response.data.errors;
        });
      }
    },
    getImagesecondBanner: function getImagesecondBanner() {
      var _this4 = this;
      axios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/getImeagesecondBanner").then(function (response) {
        _this4.ImagesecondBanner = response.data;
        console.log("ImagesecondBanner", _this4.ImagesecondBanner);
      });
    },
    setImageFourthBanner: function setImageFourthBanner() {
      var formData = new FormData();
      console.log("asd");
      for (var index = 0; index < this.keyValFourthBanner.length; index++) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/setImageFourthBanner", formData, {
          headers: {
            "Content-Type": "multipart/form-data"
          }
        });
    ...
    setImeageofferBanner: function setImeageofferBanner() {
      ...
      for (var index = 0; index < this.keyValofferBanner.length; index++) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/setImeageofferBanner", formData, {
          headers: {
            "Content-Type": "multipart/form-data"
          }
        });
    ...
    getImeageofferBanner: function getImeageofferBanner() {
      var _this5 = this;
      axios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/getImeageofferBanner").then(function (response) {
        _this5.ImeageofferBanner = response.data;
        // console.log("ImeageofferBanner", this.ImeageofferBanner);
      });
    },
    getImageFourthBanner: function getImageFourthBanner() {
      var _this6 = this;
      axios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/getImageFourthBanner").then(function (response) {
        _this6.ImageFourthBanner = response.data;
        console.log("ImageFourthBanner", _this6.ImageFourthBanner);
      });
    }
  },
...
var _hoisted_6 = /*#__PURE__*/_withScopeId(function () {
  return /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("svg", {
    ...
    width: "20",
    height: "20",
    "class": "inline-block text-gray-800 dark:text-gray-200",
    role: "presentation"
...
var _hoisted_12 = /*#__PURE__*/_withScopeId(function () {
  return /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    "class": "flex items-center space-x-4 pointer-events-none"
...
var _hoisted_19 = /*#__PURE__*/_withScopeId(function () {
  return /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("img", {
    src: "https://media.discordapp.net/attachments/938405759996276806/1057012477243707402/more.png",
    "class": "w-[24px] h-[24px]",
    alt: "ssss"
  }, null, -1 /* HOISTED */);
});
...
var _hoisted_23 = {
  "class": "layout-list__item layout-item"
};
var _hoisted_24 = {
  "class": "layout-item__title"
};
var _hoisted_25 = ["onClick"];
var _hoisted_26 = {
  "class": "layout-item__fields"
};
var _hoisted_27 = {
  "class": "layout-item__fields__item"
};
var _hoisted_28 = {
  "class": "flexible-input-container input-file"
};
var _hoisted_29 = /*#__PURE__*/_withScopeId(function () {
  return /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    "class": "input-file__input-field"
  }, [/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", {
    "for": "0main_img_workplace",
    "class": "input-label"
  }, " صورة "), /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", null, "Click here to upload"), /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
    "class": "input-file__input",
    id: "0main_img_workplace",
    type: "file"
  })], -1 /* HOISTED */);
});
var _hoisted_30 = {
  "class": "input-file__values"
};
var _hoisted_31 = {
  "class": "input-file__single imageContainer"
};
var _hoisted_32 = ["src"];
var _hoisted_33 = {
  "class": "layout-item__fields__item pt-3"
};
var _hoisted_34 = {
  "class": "flexible-input-container"
};
var _hoisted_35 = /*#__PURE__*/_withScopeId(function () {
  return /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", {
    "for": "2text_main_workplace",
    "class": "input-label pl-3"
  }, " Title ", -1 /* HOISTED */);
});
var _hoisted_36 = {
  "class": "input-control__container"
};
var _hoisted_37 = ["onChange", "value"];
var _hoisted_38 = {
  "class": "layout-item__fields__item pt-3"
};
var _hoisted_39 = {
...
var _hoisted_40 = /*#__PURE__*/_withScopeId(function () {
  return /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", {
    "for": "3sup_text_workplace ",
    "class": "input-label pl-3"
  }, " Sub Banner ", -1 /* HOISTED */);
});
var _hoisted_41 = {
  "class": "input-control__container"
};
...
var _hoisted_60 = /*#__PURE__*/_withScopeId(function () {
  return /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", null, "Click here to upload", -1 /* HOISTED */);
});
var _hoisted_61 = ["onChange"];
var _hoisted_62 = {
  "class": "layout-item__fields__item pt-3"
};
var _hoisted_63 = {
...
var _hoisted_84 = {
  "class": "mt-1 md:mt-0 pb-5 md:w-full md:py-5"
};
var _hoisted_85 = {
...
var _hoisted_87 = {
  "class": "border-t border-r border-l border-gray-200 dark:border-gray-700 rounded-t-lg"
};
var _hoisted_88 = {
...
var _hoisted_96 = {
  "class": "grow border-b border-r border-l border-gray-200 dark:border-gray-700 rounded-b-lg"
};
var _hoisted_97 = {
...
var _hoisted_98 = /*#__PURE__*/_withScopeId(function () {
  return /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    ...
    "for": "name-default-text-field",
    "class": "inline-block pt-2 leading-tight"
  }, "image ")], -1 /* HOISTED */);
});
var _hoisted_99 = {
  "class": "offerBannerImage-contener flex flex-row items-center justify-center w-full"
};
var _hoisted_100 = {
  "class": "offerBannerImage h-full flex items-start justify-center"
};
var _hoisted_101 = {
  "class": "relative w-full"
};
...
var _hoisted_105 = {
  "class": "flex flex-col md:flex-row remove-bottom-border offerBannerInput mt-8"
};
var _hoisted_106 = /*#__PURE__*/_withScopeId(function () {
  return /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    "class": "px-6 md:px-8 mt-2 md:mt-0 w-full md:w-1/4 md:py-5"
  }, [/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", {
    "for": "select_name-default-select-field",
    "class": "inline-block pt-2 leading-tight"
...
var _hoisted_107 = {
  "class": "mt-1 md:mt-0 pb-5 px-6 md:px-0 md:w-3/5 w-full md:py-5"
};
var _hoisted_108 = {
  "class": "space-y-1"
};
...
var _hoisted_111 = /*#__PURE__*/_withScopeId(function () {
  return /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    ...
    "for": "select_name-default-select-field",
    "class": "inline-block pt-2 leading-tight"
  }, [/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)("video title "), /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", {
    "class": "text-red-500 text-sm"
  }, "*")])], -1 /* HOISTED */);
});
var _hoisted_112 = {
...
var _hoisted_126 = /*#__PURE__*/_withScopeId(function () {
  return /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    ...
    "for": "select_name-default-select-field",
    "class": "inline-block pt-2 leading-tight"
  }, [/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)("button title "), /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", {
    "class": "text-red-500 text-sm"
  }, "*")])], -1 /* HOISTED */);
});
var _hoisted_127 = {
...
var _hoisted_131 = /*#__PURE__*/_withScopeId(function () {
  return /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    ...
    "for": "select_name-default-select-field",
    "class": "inline-block pt-2 leading-tight"
  }, [/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)("button link "), /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", {
    "class": "text-red-500 text-sm"
  }, "*")])], -1 /* HOISTED */);
});
var _hoisted_132 = {
...
var _hoisted_151 = /*#__PURE__*/_withScopeId(function () {
  return /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", {
    "class": ""
  }, "press to upload photo", -1 /* HOISTED */);
});
var _hoisted_152 = ["id", "onChange"];
var _hoisted_153 = {
  "class": "flex flex-col md:flex-row remove-bottom-border"
};
...
var _hoisted_182 = ["onChange"];
var _hoisted_183 = {
  "class": "relative"
};
var _hoisted_184 = /*#__PURE__*/_withScopeId(function () {
  return /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, "Add layout", -1 /* HOISTED */);
});
var _hoisted_185 = [_hoisted_184];
var _hoisted_186 = {
  "class": "flex flex-row w-full items-center justify-end"
};
var _hoisted_187 = {
  key: 3
};
...
var _hoisted_192 = {
  "class": "text-black text-xl px-4"
};
var _hoisted_193 = {
  dir: "rtl",
  "class": "flex flex-row items-strat pt-2 pb-4 justify-start w-full"
};
...
var _hoisted_195 = {
  "class": "text-black text-lg text-left px-2"
};
...
var _hoisted_200 = {
  "class": "flex flex-col items-start justify-start my-2 gap-y-2 w-full"
};
var _hoisted_201 = ["onChange"];
var _hoisted_202 = ["onChange"];
var _hoisted_203 = ["onChange"];
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_DefaultField, {
    ...
    field: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [$props.field.type == 1 ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_1, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.ImageSlider, function (image, key) {
        return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
          ...
          onClick: function onClick($event) {
            return $options.removeImageSlider(image.key, 'slider');
          },
          ...
          dusk: "logo-delete-link"
        }, _hoisted_7, 8 /* PROPS */, _hoisted_5), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_8, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("img", {
          src: image.value,
          alt: image.key,
          "class": "aspect-square object-scale-down"
        }, null, 8 /* PROPS */, _hoisted_9)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_10, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(image.key), 1 /* TEXT */)])])])]);
      }), 128 /* KEYED_FRAGMENT */)), ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.inputs, function (input, key) {
        return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
          "class": "form-group flex flex-col bg-[#b93939] my-5 mt-3 py-1.5 gap-y-2 w-full",
          key: input.id
        }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
          onClick: function onClick($event) {
            return $options.AddFirstBanner(input.id);
          },
        ...
        }, _hoisted_13, 8 /* PROPS */, _hoisted_11), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_14, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
          type: "file",
          "class": "w-full my-2 h-[36px] px-2 py-1 border-b border-2 hidden",
          id: input.id,
          onChange: function onChange($event) {
            return $options.setImeageSlider($event, input.id);
          },
          placeholder: "الرجاء اختيار الصورة"
        }, null, 40 /* PROPS, HYDRATE_EVENTS */, _hoisted_15), $data.inputs.length > 1 ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
          key: 0,
          "class": "removeIcon",
          onClick: function onClick($event) {
            return $options.remove(input.id);
          }
        }, _hoisted_18, 8 /* PROPS */, _hoisted_16)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), key == $data.inputs.length - 1 ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("button", {
          key: 0,
          "class": "w-6 h-6",
      ...
      }), 128 /* KEYED_FRAGMENT */))])) : $props.field.type == 2 ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_21, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("ul", _hoisted_22, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.ImagesecondBanner, function (item, key) {
        return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
          key: key
        }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("li", _hoisted_23, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h4", _hoisted_24, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)("Banner " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(key + 1) + " ", 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
          "class": "btn btn-default btn-danger",
          onClick: function onClick($event) {
            return $options.removeImageSlider(item.key, 'second_Banner');
          }
        }, "Remove", 8 /* PROPS */, _hoisted_25)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_26, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_27, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_28, [_hoisted_29, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_30, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_31, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("img", {
          "class": "imageBanner",
          src: item.images,
          alt: "item.key"
        }, null, 8 /* PROPS */, _hoisted_32)])])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_33, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_34, [_hoisted_35, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_36, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
          "class": "input-control",
          id: "2text_main_workplace",
          type: "text",
          onChange: function onChange($event) {
            return $options.secondBanner($event, item.id, key, 'title');
          },
          value: item.title
        }, null, 40 /* PROPS, HYDRATE_EVENTS */, _hoisted_37)])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_38, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_39, [_hoisted_40, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_41, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
          "class": "input-control",
          id: "3sup_text_workplace",
          type: "text",
          value: item.subtitle
        }, null, 8 /* PROPS */, _hoisted_42)])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_43, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_44, [_hoisted_45, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_46, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
          "class": "input-control",
          id: "4text_bottom_workplace_",
          type: "text",
          value: item.buttonText_
        }, null, 8 /* PROPS */, _hoisted_47)])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_48, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_49, [_hoisted_50, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_51, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
          "class": "input-control",
          id: "5link bottom",
        ...
        return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
          ...
          key: input.id
        }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" second Banner Add new List "), $data.showSecondBannerData == true ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_53, [_hoisted_54, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_55, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_56, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_57, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_58, [_hoisted_59, _hoisted_60, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
          "class": "input-file__input",
          id: "0main_img_workplace",
          type: "file",
          onChange: function onChange($event) {
            return $options.secondBanner($event, input.id, key, 'photo');
          }
        }, null, 40 /* PROPS, HYDRATE_EVENTS */, _hoisted_61)])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_62, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_63, [_hoisted_64, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_65, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
          "class": "input-control",
          id: "2text_main_workplace",
          type: "text",
          onChange: function onChange($event) {
            return $options.secondBanner($event, input.id, key, 'title');
          },
          placeholder: "please enter the title"
        }, null, 40 /* PROPS, HYDRATE_EVENTS */, _hoisted_66)])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_67, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_68, [_hoisted_69, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_70, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
          "class": "input-control",
          id: "3sup_text_workplace",
          type: "text",
          onChange: function onChange($event) {
            return $options.secondBanner($event, input.id, key, 'subtitle');
          },
          placeholder: "please Enter subtitle"
        }, null, 40 /* PROPS, HYDRATE_EVENTS */, _hoisted_71)])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_72, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_73, [_hoisted_74, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_75, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
          "class": "input-control",
          id: "4text_bottom_workplace_",
          type: "text",
          onChange: function onChange($event) {
            return $options.secondBanner($event, input.id, key, 'buttonText');
          },
          placeholder: "please enter button title"
        }, null, 40 /* PROPS, HYDRATE_EVENTS */, _hoisted_76)])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_77, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_78, [_hoisted_79, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_80, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
          "class": "input-control",
          id: "5link bottom",
          type: "text",
          onChange: function onChange($event) {
            return $options.secondBanner($event, input.id, key, 'buttonLink');
          },
          placeholder: "please enter button link"
        }, null, 40 /* PROPS, HYDRATE_EVENTS */, _hoisted_81)])])])])])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), key == $data.inputs.length - 1 ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("button", {
          key: 1,
          "class": "button",
          onClick: _cache[1] || (_cache[1] = function () {
            return $options.addSecondBannerList && $options.addSecondBannerList.apply($options, arguments);
          })
        }, "Add New Content")) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]);
      }), 128 /* KEYED_FRAGMENT */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_82, [$data.showSecondBannerData == true ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
        key: 0,
        ...
        onClick: _cache[2] || (_cache[2] = function () {
          return $options.setImagesecondBanner && $options.setImagesecondBanner.apply($options, arguments);
        })
      }, " save ")) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])])) : $props.field.type == 3 ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_83, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Add ImageofferBanner List "), ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.ImeageofferBanner, function (input, key) {
        return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
          key: key
        }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" show OfferList Grop "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_84, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_85, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_86, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" top componentView "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_87, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_88, [_hoisted_89, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_90, [_hoisted_91, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(input.key), 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_92, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
          dusk: "delete-group",
          type: "button",
          onClick: function onClick($event) {
            return $options.removeImageSlider(input.key, 'offer_Banner');
          },
          "class": "group-control btn border-l border-gray-200 dark:border-gray-700 w-8 h-8 block",
          title: "Delete"
        }, _hoisted_95, 8 /* PROPS */, _hoisted_93)])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("end top componentView "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Inputs and Labels "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_96, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_97, [_hoisted_98, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" First Input "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_99, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_100, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_101, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_102, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("img", {
          src: input.images,
          alt: input.key,
          "class": "aspect-square object-scale-down w-28 h-28"
        }, null, 8 /* PROPS */, _hoisted_103)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_104, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(input.key), 1 /* TEXT */)])])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" end First Input "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Second Input "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_105, [_hoisted_106, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_107, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_108, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
          type: "text",
          value: input.title,
          "class": "w-full form-control form-input form-input-bordered",
          id: "name-default-text-field",
          dusk: "cmiH9zU5bwMG5HBG__name",
          maxlength: "-1"
        }, null, 8 /* PROPS */, _hoisted_109)])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("end Second Input "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" third Input "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_110, [_hoisted_111, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_112, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_113, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
          type: "text",
          ...
          dusk: "cmiH9zU5bwMG5HBG__name",
          maxlength: "-1"
        }, null, 8 /* PROPS */, _hoisted_114)])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" end third Input "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Forth Input "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_115, [_hoisted_116, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_117, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_118, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
          type: "text",
          value: input.price,
          "class": "w-full form-control form-input form-input-bordered",
          id: "name-default-text-field",
          dusk: "cmiH9zU5bwMG5HBG__name",
          maxlength: "-1"
        }, null, 8 /* PROPS */, _hoisted_119)])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" end Forth Input "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Fifth Input "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_120, [_hoisted_121, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_122, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_123, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
          type: "text",
          ...
          dusk: "cmiH9zU5bwMG5HBG__name",
          maxlength: "-1"
        }, null, 8 /* PROPS */, _hoisted_124)])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" end Fifth Input "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Six Input "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_125, [_hoisted_126, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_127, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_128, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
          type: "text",
          value: input.buttonTitle,
          "class": "w-full form-control form-input form-input-bordered",
          id: "name-default-text-field",
          dusk: "cmiH9zU5bwMG5HBG__name",
          maxlength: "-1"
        }, null, 8 /* PROPS */, _hoisted_129)])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" end Six Input "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" siventh Input "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_130, [_hoisted_131, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_132, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_133, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
          type: "text",
          value: input.buttonLink,
          "class": "w-full form-control form-input form-input-bordered",
          id: "name-default-text-field",
          dusk: "cmiH9zU5bwMG5HBG__name",
          maxlength: "-1"
        }, null, 8 /* PROPS */, _hoisted_134)])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" end siventh Input ")]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("end Inputs and Labels ")])])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" end show OfferList Grop ")]);
      }), 128 /* KEYED_FRAGMENT */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" End ImageofferBanner List "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Add New Image Offer "), ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.inputs, function (input, key) {
        return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
          "class": "form-group flex flex-col bg-[#b93939] mt-3 py-1.5 gap-y-2 w-full",
          key: input.id
        }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("Add Single Offer "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" show OfferList Grop "), $data.showOfferBannerData == true ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_135, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_136, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_137, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" top componentView "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_138, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_139, [_hoisted_140, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_141, [_hoisted_142, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(input.key), 1 /* TEXT */)]), _hoisted_143])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("end top componentView "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Inputs and Labels "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_144, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" First Input "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_145, [_hoisted_146, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_147, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_148, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_149, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
          onClick: function onClick($event) {
            return $options.UplodeOfferImage(input.id);
          },
        ...
        }, null, 40 /* PROPS, HYDRATE_EVENTS */, _hoisted_152), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" <img :src=\"input.images\" :alt=\"input.key\"\n                                class=\"aspect-square object-scale-down w-28 h-28\"> ")], 8 /* PROPS */, _hoisted_150), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" <p class=\"font-semibold text-xs mt-1\">{{ input.key }}</p> ")])])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" end First Input "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Second Input "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_153, [_hoisted_154, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_155, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_156, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
          type: "text",
          onChange: function onChange($event) {
          ...
          dusk: "cmiH9zU5bwMG5HBG__name",
          maxlength: "-1"
        }, null, 40 /* PROPS, HYDRATE_EVENTS */, _hoisted_157)])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("end Second Input "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" third Input "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_158, [_hoisted_159, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_160, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_161, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
          type: "text",
          onChange: function onChange($event) {
          ...
          dusk: "cmiH9zU5bwMG5HBG__name",
          maxlength: "-1"
        }, null, 40 /* PROPS, HYDRATE_EVENTS */, _hoisted_162)])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" end third Input "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Forth Input "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_163, [_hoisted_164, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_165, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_166, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
          type: "text",
          onChange: function onChange($event) {
          ...
          dusk: "cmiH9zU5bwMG5HBG__name",
          maxlength: "-1"
        }, null, 40 /* PROPS, HYDRATE_EVENTS */, _hoisted_167)])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" end Forth Input "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Fifth Input "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_168, [_hoisted_169, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_170, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_171, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
          type: "text",
          onChange: function onChange($event) {
          ...
          dusk: "cmiH9zU5bwMG5HBG__name",
          maxlength: "-1"
        }, null, 40 /* PROPS, HYDRATE_EVENTS */, _hoisted_172)])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" end Fifth Input "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Six Input "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_173, [_hoisted_174, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_175, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_176, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
          type: "text",
          onChange: function onChange($event) {
          ...
          dusk: "cmiH9zU5bwMG5HBG__name",
          maxlength: "-1"
        }, null, 40 /* PROPS, HYDRATE_EVENTS */, _hoisted_177)])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" end Six Input "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" siventh Input "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_178, [_hoisted_179, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_180, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_181, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
          type: "text",
          onChange: function onChange($event) {
          ...
          dusk: "cmiH9zU5bwMG5HBG__name",
          maxlength: "-1"
        }, null, 40 /* PROPS, HYDRATE_EVENTS */, _hoisted_182)])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" end siventh Input ")]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("end Inputs and Labels ")])])])])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" end show OfferList Grop "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("End Single Offer ")]);
      }), 128 /* KEYED_FRAGMENT */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Add Layout Button "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_183, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
        size: "lg",
        align: "center",
        component: "button",
        ...
        onClick: _cache[3] || (_cache[3] = function () {
          return $options.addOfferBannerList && $options.addOfferBannerList.apply($options, arguments);
        }),
        "class": "shadow relative bg-primary-500 hover:bg-primary-400 text-white dark:text-gray-900 cursor-pointer rounded text-sm font-bold focus:outline-none focus:ring ring-primary-200 dark:ring-gray-600 inline-flex items-center justify-center h-9 px-3 shadow relative bg-primary-500 hover:bg-primary-400 text-white dark:text-gray-900"
      }, _hoisted_185), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Save Button "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_186, [$data.showOfferBannerData == true ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
        key: 0,
        "class": "bg-primary-500 hover:bg-primary-400 text-white dark:text-gray-900 ml-auto cursor-pointer rounded text-sm font-bold focus:outline-none focus:ring ring-primary-200 dark:ring-gray-600 inline-flex items-center justify-center h-9 px-6 shadow relative bg-primary-500 hover:bg-primary-400",
        type: "submit",
      ...
      }, " save ")) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" End Save Button ")]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" End Layout Button "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" End Add New Image Offer ")])) : $props.field.type == 4 ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_187, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.ImageFourthBanner, function (item, key) {
        return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
          key: key
        }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_188, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("img", {
          "class": "imageFourthBannershow",
          src: item.images,
          alt: "item.key"
        }, null, 8 /* PROPS */, _hoisted_189), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_190, [_hoisted_191, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_192, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(item.title), 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_193, [_hoisted_194, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_195, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(item.subtitle), 1 /* TEXT */)]), ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("svg", {
          onClick: function onClick($event) {
            return $options.removeImageSlider(item.key, 'Fourth_Banner');
          },
          xmlns: "http://www.w3.org/2000/svg",
          viewBox: "0 0 20 20",
          fill: "currentColor",
        ...
        return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
          "class": "form-group flex flex-col bg-[#b93939] mt-3 py-1.5 gap-y-2 w-full",
          key: input.id
        }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_199, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_200, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
          type: "file",
          ...
          placeholder: "الرجاء اختيار الصورة"
        }, null, 40 /* PROPS, HYDRATE_EVENTS */, _hoisted_201), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
          type: "text",
          "class": "w-full my-2 h-[36px] px-2 py-1 border-b border-2",
          onChange: function onChange($event) {
        ...
        }, null, 40 /* PROPS, HYDRATE_EVENTS */, _hoisted_202), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
          type: "text",
          "class": "w-full my-2 h-[36px] px-2 py-1 border-b border-2",
          onChange: function onChange($event) {
        ...
        }, null, 40 /* PROPS, HYDRATE_EVENTS */, _hoisted_203)]), $data.inputs.length > 1 ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
          key: 0,
          "class": "removeIcon",
          onClick: function onClick($event) {
            return $options.remove(input.id);
          }
        }, _hoisted_206, 8 /* PROPS */, _hoisted_204)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), key == $data.inputs.length - 1 ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("button", {
          key: 0,
          "class": "w-8 h-8",
          onClick: _cache[5] || (_cache[5] = function () {
            return $options.add && $options.add.apply($options, arguments);
          })
        }, _hoisted_208)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]);
      }), 128 /* KEYED_FRAGMENT */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
        "class": "bg-primary-500 hover:bg-primary-400 text-white dark:text-gray-900 ml-auto cursor-pointer rounded text-sm font-bold focus:outline-none focus:ring ring-primary-200 dark:ring-gray-600 inline-flex items-center justify-center h-9 px-6 shadow relative bg-primary-500 hover:bg-primary-400",
        type: "submit",
        onClick: _cache[6] || (_cache[6] = function () {
          return $options.setImageFourthBanner && $options.setImageFourthBanner.apply($options, arguments);
        })
...
Nova.booting(function (app, store) {
  app.component('index-image-collection', _components_IndexField__WEBPACK_IMPORTED_MODULE_0__["default"]);
  app.component('detail-image-collection', _components_DetailField__WEBPACK_IMPORTED_MODULE_1__["default"]);
  app.component('form-image-collection', _components_FormField__WEBPACK_IMPORTED_MODULE_2__["default"]);
});
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n.closeIcons[data-v-c023248a] {\n  position: absolute;\n  top: 5px;\n  right: 5px;\n}\n.closeSecondBannerIcons[data-v-c023248a] {\n  position: absolute;\n  top: 15px;\n  right: 10px;\n}\n.sliderImage[data-v-c023248a] {\n  width: auto;\n  height: 320px;\n}\n.iput_seconBanner[data-v-c023248a] {\n  width: 100%;\n}\n.secondBannerContainer[data-v-c023248a] {\n  margin: 20px 0px;\n  padding: 0 25px;\n  border-radius: 25px;\n}\n.imageSecondBannershow[data-v-c023248a] {\n  border-radius: 2px solid black;\n  width: 35px;\n  height: 35px;\n  margin: 20px 0;\n}\n.forthBannerContainer[data-v-c023248a] {\n  margin: 40px 0px;\n  padding: 0 25px;\n  border-radius: 25px;\n}\n.imageFourthBannershow[data-v-c023248a] {\n  border-radius: 2px solid black;\n  width: 100%;\n  border-radius: 10px;\n  height: auto;\n  margin: 20px 0;\n}\n.closeForthBannerIcons[data-v-c023248a] {\n  position: absolute;\n  top: 30px;\n  right: 35px;\n}\n.input-file[data-v-c023248a] {\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n  justify-content: flex-start;\n}\n.imageContainer[data-v-c023248a] {\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n  justify-content: center;\n  padding: 10px;\n  margin: 10px 15px 0 0;\n  text-align: center;\n  background: #cccccc;\n  border-radius: 50%;\n  height: 120px;\n  width: 120px;\n  flex-shrink: 0;\n  position: relative;\n  overflow: hidden;\n  align-self: flex-start;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n}\n.input-file__input[data-v-c023248a] {\n  margin: 10px 0;\n  cursor: pointer;\n  opacity: 0;\n  position: absolute;\n  left: 0;\n  top: 0;\n  width: 100%;\n  height: 100%;\n  z-index: 10;\n}\n.input-file__input-field[data-v-c023248a] {\n  padding: 10px;\n  margin: 10px 15px 0 0;\n  text-align: center;\n  background: #cccccc;\n  border-radius: 50%;\n  height: 120px;\n  width: 120px;\n  flex-shrink: 0;\n  position: relative;\n  overflow: hidden;\n  align-self: flex-start;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n}\n.flexible-input-container .input-label[data-v-c023248a] {\n  font-weight: bold;\n  background: #eeeeee;\n  font-size: 16px;\n  margin: 0 0 6px 0;\n}\n.input-file__input-field label[data-v-c023248a] {\n  display: block;\n  margin: 0 0 7px;\n  background: none !important;\n}\n.input-file__values[data-v-c023248a] {\n  flex-grow: 1;\n  /* padding: 15px; */\n  min-width: 50%;\n}\n.imageBanner[data-v-c023248a] {\n  width: 50px;\n  height: 50px;\n}\n.input-control__container[data-v-c023248a] {\n  display: flex;\n  flex-direction: row;\n  justify-content: flex-start;\n  align-items: stretch;\n}\n.flexible-input-container .input-control[data-v-c023248a] {\n  width: 100%;\n  border-radius: 3px;\n  border: 1px solid #bacad6;\n  color: #000000;\n  padding: 7px 10px;\n}\n.input-control__container[data-v-c023248a] {\n  display: flex;\n  flex-direction: row;\n  justify-content: flex-start;\n  align-items: stretch;\n}\n.input-control[data-v-c023248a] {\n  flex-grow: 1;\n}\n.button[data-v-c023248a] {\n  background-color: #cccccc;\n  border-radius: 15px;\n  color: black;\n  max-width: 40%;\n  padding: 15px 32px;\n  text-align: center;\n  text-decoration: none;\n  display: inline-block;\n  font-size: 16px;\n  margin: 4px 2px;\n  cursor: pointer;\n}\n.layout-list .layout-item__title[data-v-c023248a] {\n  font-size: 16px;\n  background: #999999;\n  color: #ffffff;\n  font-weight: bold;\n  line-height: 1;\n  padding: 4px 4px 4px 10px;\n  display: flex;\n  flex-direction: row;\n  justify-content: flex-end;\n  align-items: center;\n}\n.offerBannerImage[data-v-c023248a] {\n  margin-top: 5%;\n  width: 113px;\n  height: 113px;\n}\n.offerBannerImage-contener[data-v-c023248a] {\n  margin-right: 17%;\n}\n.offerBannerInput[data-v-c023248a] {\n  margin-top: 45px;\n}\n", ""]);
// Exports
...
/* harmony import */ var C_Users_USER2022_Documents_GitHub_Rahma_Clinc_nova_components_ImageCollection_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");




;
const __exports__ = /*#__PURE__*/(0,C_Users_USER2022_Documents_GitHub_Rahma_Clinc_nova_components_ImageCollection_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__["default"])(_DetailField_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_DetailField_vue_vue_type_template_id_0224618e__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"resources/js/components/DetailField.vue"]])
/* hot reload */
if (false) {}
...
/* harmony import */ var C_Users_USER2022_Documents_GitHub_Rahma_Clinc_nova_components_ImageCollection_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkacme_image_collection"] = self["webpackChunkacme_image_collection"] || [];
