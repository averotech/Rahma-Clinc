                ...
                <div class="flex justify-between">
                            ...
                            <li>
                                <a href="" target="_blank" class="rounded-full w-[24px] h-[24px] border border-[#959797] flex justify-center items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                                        ...
                                        <path d="M7.9751 13.7578V7.52231H10.0672L10.3811 5.09152H7.9751V3.53981C7.9751 2.83626 8.16967 2.3568 9.1797 2.3568L10.4658 2.35627V0.182084C10.2434 0.15318 9.47992 0.0869141 8.59132 0.0869141C6.73578 0.0869141 5.46544 1.21952 5.46544 3.29907V5.09152H3.36694V7.52231H5.46544V13.7578H7.9751Z" fill="#959797"></path>
                                        </g>
                                        <defs>
                                        <clipPath id="clip0_2_330">
                                        <rect width="13.6709" height="13.6709" fill="white" transform="translate(0.0809326 0.0869141)"></rect>
                                        </clipPath>
                                        </defs>
                                    </svg>
                                </a>
                    ...
                    <div class="mr-10 ">
                        <ul class="flex flex-wrap justify-between text-[12px] poppins-font font-[600] text-[#727475]">
                            <li class="sm:ml-4">
                                <p>هاتف : <a href="#">+43 (0) 650 730 2158</a></p>
                            </li>
                            <li class="ml-4 hidden sm:block">
                                <p>ايميل : <a href="#">info@schatzi-kitzbuehel.at</a></p>
                            </li>
